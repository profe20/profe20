...
class propertyReview(models.Model):
 ...
 property = models.ForeignKey('property', related_name='Review_author', on_delete=models.CASCADE)
 price=models.IntegerField(default=0)
...
class propertyBook(models.Model):
 ...
 author = models.ForeignKey('user', related_name='Book_owner', on_delete=models.CASCADE)
 property = models.ForeignKey('property', related_name='Review_author', on_delete=models.CASCADE)
 phone_number = models.CharField(max_length=12) 
 gute_to=models.CharField(choices=count ,max_length=100)
